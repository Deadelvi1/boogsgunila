...
@section('content')
<h1 class="text-2xl font-extrabold text-gray-800 mb-4">Edit Pengguna</h1>
		...
		<div class="space-y-4">
			...
			<div>
				...
				<input type="text" name="phone" value="{{ old('phone', $user->phone) }}"
					class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="0812xxxx">
			</div>
			<div>
			...
			<div>
				...
				<select name="role" required class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
					<option value="U" {{ old('role', $user->role) === 'U' ? 'selected' : '' }}>User</option>
